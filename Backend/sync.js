...
function fetchEntries(contestID, func) {
    ...
    //Send a GET AJAX request to get the contest entries
    getApi("https://www.khanacademy.org/api/internal/scratchpads/" + contestID + "/top-forks?casing=camel&sort=2&limit=300000&page=0&lang=en", function(apiResponse) {
        //The contest entries
        var entries = [];
...
var sync = function(func) {
    ...
    //Send a GET AJAX request to get the contests
    getApi("https://www.khanacademy.org/api/internal/scratchpads/top?casing=camel&topic_id=xffde7c31&sort=4&limit=40000&page=0&lang=en&_=1436581332879", function(apiResponse) {
